...
Script containing custom layer implementation for self-attention mechanisms in TensorFlow
...
class SelfAttention(Layer):
    ...
    def __init__(self, size, num_hops=8, use_penalization=True,
        ...
        if model_api not in ['sequential', 'functional', 'matrix']:
